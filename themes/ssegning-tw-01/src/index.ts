...
class DGRVBranding {
  ...
  private static addBrandText(): void {
  ...
  private static ensureDGRVLogo(): void {
    const logoContainer = document.querySelector('#kc-logo');
    if (logoContainer) {
      // Check if there's already an image
      let logoImg = logoContainer.querySelector('img') as HTMLImageElement;
  ...
  private static updatePageContent(): void {
    // Update page title
  ...
  private static styleAllLinks(): void {
  ...
  private static forceUpdateLinkColors(): void {
  ...
  private static removeRealmText(): void {
...
class FormEnhancements {
  ...
  private static enhanceInputFields(): void {
  ...
  private static addLoadingStates(): void {
  ...
  private static enhanceErrorMessages(): void {
